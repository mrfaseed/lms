...
export default function CreateTestPage() {
  ...
  // Fetch courses so admin can assign a test to a specific course
  useEffect(() => {
    // Basic fetch from existing route proxy or directly to backend
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-4">
        <Link href="/admin/tests" className="p-2 hover:bg-slate-200 bg-slate-100 rounded-full transition-colors text-slate-500 hover:text-slate-900">
