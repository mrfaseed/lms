...
export default function AdminTestDetailPage() {
  ...
  if (!test) return <div className="p-12 text-center font-bold text-slate-700">Test not found.</div>;
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 pb-32">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/admin/tests" className="p-2 hover:bg-white bg-slate-50 border border-slate-200 rounded-full transition-colors text-slate-500 hover:text-slate-900">
